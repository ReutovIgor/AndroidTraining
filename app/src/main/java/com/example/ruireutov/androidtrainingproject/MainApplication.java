...
import com.example.ruireutov.androidtrainingproject.Components.DaggerPresenterControlComponent;
...
public class MainApplication extends Application {
    ...
    public void onCreate() {
        ...
        taskControlComponent = DaggerTaskControlComponent.builder()
                ...
                .build();
        presenterControlComponent = DaggerPresenterControlComponent.builder()
                .taskRepositoryControl(taskControlComponent.getTaskRepositoryControl())
                .build();
    }
    ...
    public PresenterControlComponent getPresenterControlComponent() {
        return presenterControlComponent;
    }
}
